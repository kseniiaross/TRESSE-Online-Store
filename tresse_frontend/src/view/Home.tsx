...
import type { RootState } from "../store"; // если путь другой — поправишь
import {
...
const columns = [pickImagesByPrefix("line1"), pickImagesByPrefix("line2"), pickImagesByPrefix("line3")];
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const onKeyDown = (e: KeyboardEvent) => {
      if (e.key === "Escape") handleCloseNewsletter();
    };
  ...
  return (
    <div className="home">
      ...
      {isNewsletterOpen ? (
        <div className="newsletter" role="dialog" aria-modal="true" aria-label="Subscribe to Tresse emails">
          <button
            type="button"
          ...
          <div className="newsletter__panel" role="document">
            ...
            <div className="newsletter__header">
              <h2 className="newsletter__title">SUBSCRIBE TO TRESSE EMAILS</h2>
              <p className="newsletter__subtitle">Stay updated on new collections, styling tips and special offers.</p>
            </div>
            ...
            <form className="newsletter__form" onSubmit={handleSubmitNewsletter}>
              ...
              {isSubmitted ? (
                ...
                <p className="newsletter__fineprint">
                  ...
                  <Link className="newsletter__link" to="/help#terms">
                    Terms
                  </Link>{" "}
                  and{" "}
                  <Link className="newsletter__link" to="/help#privacy">
                    Privacy Policy
                  </Link>
                  .
                </p>
